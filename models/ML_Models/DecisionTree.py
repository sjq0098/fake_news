...
model_name = "DecisionTreeClassifier_WithoutLimitation"  # 可根据实际情况修改
# 生成分类报告
...
#graph.render(os.path.join(result_dir, f"{model_name}_decision_tree"), format='png')
#print(f"决策树图像已保存到: {os.path.join(result_dir, f'{model_name}_decision_tree.png')}")
